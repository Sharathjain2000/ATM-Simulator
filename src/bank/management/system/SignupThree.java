...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno)
    {
        this.formno=formno;
        setLayout(null);
        JLabel l1 = new JLabel("Part 3:Account Details");
        ...
        JLabel number = new JLabel("xxxx-xxxx-xxxx-4108");
        ...
        pinnumber.setBounds(330, 370, 250, 30);
        add(pinnumber);
        ...
        services.setBounds(100, 456, 400, 25);
        add(services);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit)
        {
            ...
            try{
                ...
                {
                    JOptionPane.showMessageDialog(null, "Account Type Requared");
                }
                else
                {
                    Conn conn = new Conn();
